...
-- ara tabloya ihtiyac var
-- Not: ys_id "unique" kisittir. Aksi halde Many-to-Many olurdu
...
-- 1-to-Many Unidirectional ile ayni ancak unique kisit yok
